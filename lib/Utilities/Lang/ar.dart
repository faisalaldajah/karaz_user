const Map<String, String> ar = {
  ...
  'select': 'إختيار',
  'yourmobilenumber': 'رقم الهاتف',
  'mobileNubmber': 'رقم الهاتف',
  ...
  'phone number must start with 0': 'رقم الهاتف يجب أن يبدأ بصفر',
  'phone number must be 10 numbers': 'رقم الهاتف يجب أن يكون 10 أرقام',
  ...
  'Phone Number must be similar to Freelance.sa':
      'رقم الهاتف يجب ان يتوافق مع الرقم في منصة العمل الحر',
  ...
  'Waiting To Accept': 'إنتظر حتى يتم الرد',
  ...
  'Write here…': 'أكتب هنا...',
  'Rate the service requester': 'قيم طالب الخدمة',
  ...
  'No internet connectivity': 'لا يوجد اتصال بشبكة',
  'user-not-found': 'لايوجد حساب بهذا الايميل',
  'wrong-password': 'كلمة مرور خاطئة',
  'email-already-in-use': 'البريد الالكتروني مستخدم',
  'Please fill the required fields': 'يرجى تعبئة جميع الحقول المطلوبة',
  'Where are you want to going?': 'إلى أين تريد أن تذهب؟',
  'Search Destination': 'البحث عن وجهتك',
  'Where you to go?': 'إلى أين تذهب؟',
  'Set Destination': 'حدد وجهتك',
